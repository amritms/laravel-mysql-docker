...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('./public/admin-lte/plugins/iCheck/square/blue.css') }}">
...
<!-- Bootstrap 3.3.5 -->
<script src="{{ asset('./public/admin-lte/bootstrap/js/bootstrap.min.js') }}"></script>
<!-- iCheck -->
<script src="{{ asset('./public/admin-lte/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
